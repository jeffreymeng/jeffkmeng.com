  ...
  return (
    <main className={cx(darkMode && "dark")}>
      <ParallaxProvider>
        ...
        <ParallaxBanner className="min-h-[22vh] sm:h-[30vh] w-full">
          <ParallaxBannerLayer
            image="/header.webp"
            className={""}
            speed={-20}
            expanded={true}
            translateY={["-200px", "-70px"]}
          ></ParallaxBannerLayer>
          <ParallaxBannerLayer
            className={
              "relative py-8 sm:py-16 pb-24 mx-auto max-w-7xl px-6 md:px-16 lg:px-36 z-10 opacity-95"
            }
          >
            ...
            <div className="max-w-3xl">
              <div className="text-base leading-7 text-gray-700 dark:text-gray-300">
                <p>
                  ...
                  . My passion is building well-designed applications and
                  systems that increase efficiency and create exceptional
                  experiences. During my time off from school, I&apos;ve been
                  fortunate enough to have the chance to intern at various cool
                  companies: I&apos;m currently at{" "}

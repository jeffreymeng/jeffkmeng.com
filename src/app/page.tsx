...
export default function Home() {
  ...
  useEffect(() => {
    const handler = () => {
      if (window.scrollY < window.innerHeight * 0.5) {
        setBgTranslate(-window.scrollY * 0.75);
  ...
  return (
    <main className={cx(darkMode && "dark")}>
      {/*<div className="w-screen mx-0 px-0 top-0 ">*/}
      {/*<div className={"top-0 left-0 mx-0 px-0 w-screen h-[40vh]"}>*/}
      <img
        src={"/header.jpg"}
        alt={"background image of me on a mountain pass"}
        className={"object-cover fixed h-[30vh] sm:h-[40vh] w-full -z-50"}
        style={{
      ...
      <div
        className={
          "relative py-8 sm:py-16 pb-24 mx-auto max-w-7xl px-6 md:px-16 lg:px-36 z-10 h-[30vh] sm:h-[40vh] "
        }
      >
        <div className={"sm:bottom-16 sm:absolute"}>
      ...
      <div
        className={cx(
          "relative isolate pt-4 sm:pt-8 pb-12 sm:pb-32 min-h-screen bg-gray-50 [box-shadow:0_0px_16px_0_rgb(0,0,0,0.3)]",
          darkMode && "bg-gradient-to-br to-slate-900 from-sky-900"
        )}
      >
        <div
          className={
        ...
        <div className="relative mx-auto max-w-7xl px-6 md:px-16 lg:px-36 z-10">
          <div className="max-w-3xl">
            <div className="text-base leading-7 text-gray-700 dark:text-gray-300">
              <p>
                I&apos;m an undergraduate studying Computer Science at UC
                Irvine, where I also work on compilers-related research with{" "}
                <ExternalLink href={"https://michaelfranz.com"}>
                  Prof. Michael Franz
                </ExternalLink>
                . I love deeply understanding systems, writing beautiful code,
                and creating amazing software. During my time off from school, I
                greatly enjoy interning at various cool companies: I&apos;m
                currently at{" "}
                <ExternalLink href={"https://modal.com"}>Modal</ExternalLink>{" "}
                this fall, and in Summer 2025, I&apos;ll be at{" "}
                ...
                and{" "}
                <ExternalLink href={"https://www.ibm.com"}>IBM</ExternalLink>.
              </p>
              <p className={"mt-8"}>
